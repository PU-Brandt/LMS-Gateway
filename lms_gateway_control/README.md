...
Die Testzeile `Befehl testen` sendet einen frei eingegebenen Steuersatz an den externen LMS Gateway Dienst. Mit aktivem `Nur pruefen` wird der Befehl trocken getestet, ohne Wiedergabe auszufuehren.
